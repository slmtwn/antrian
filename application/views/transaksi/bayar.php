            ...
            <div class="col-lg">
                ...
                <form method="POST" action="">
                    ...
                    <?php if ($status == '0') { ?>
                        ...
                        <?php } else { ?>
                            <a href="<?= base_url('transaksi/cetak_pembayaran/') . $bayar['id_tagihan']; ?>" target="_blank" class="btn btn-success btn-sm"><i class="fa fa-print fa-sm"></i>Cetak Struk Pembayaran</a>
                        <?php } ?>
                        </div>
                </form>
            </div>
